...
export default function Home() {
  ...
  const contractAddress = "0xE000646c669d06D84bCBbb2F3c3a87d46974dCAa";
  ...
  const buyCoffee = async (coffeePrice) => {
    try {
      const { ethereum } = window;
      ...
      if (ethereum) {
        ...
        const coffeeTxn = await buyMeACoffee.buyCoffee(
          ...
          { value: ethers.utils.parseEther(coffeePrice) }
        );
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Buy Satyajeet a Coffee!</title>
